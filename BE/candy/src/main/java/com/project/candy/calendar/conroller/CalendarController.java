...
public class CalendarController {
   ...
   * @return
   */
  @GetMapping(path = "calendar", headers = "HEADER")
  public ResponseEntity<?> findCalendarByEmailAndDate (@RequestHeader("HEADER") String userEmail, @RequestParam int year , @RequestParam int month){
