...
public interface ReviewService {
  ...
  boolean CreateReview(String userEmail,long beerId, CreateReviewRequest createReviewRequest);

  List<ReadReviewResponse> ReadAllReview(long beerId,String userEmail);
}
